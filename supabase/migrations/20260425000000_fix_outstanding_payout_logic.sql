-- Migration: fix_outstanding_payout_logic
-- Objective: Ensure outstanding_payout represents only unpaid payout rows, 
-- rather than the difference between total cost and total paid out.
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      ELSE
        -- Row is unpaid, add to outstanding
