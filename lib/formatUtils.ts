...
/**
 * Converts any date string to the local YYYY-MM-DDTHH:mm format
 * required for <input type="datetime-local" />
 */
export const toLocalDatetimeString = (date: string | Date | null): string => {
  if (!date) return '';
